...
public:
  ...
  static void IRAM_ATTR handleThrottleInterrupt(); 
  static void IRAM_ATTR handleYawInterrupt(); 
  static void IRAM_ATTR handleRollInterrupt(); 
  static void IRAM_ATTR handlePitchInterrupt(); 
...
private:
  ...
  static volatile unsigned long last_rising_edge_throttle;
  static volatile unsigned long last_rising_edge_yaw;
  static volatile unsigned long last_rising_edge_pitch;
  static volatile unsigned long last_rising_edge_roll;

  static volatile unsigned long receiver_input_channel_3;
  static volatile unsigned long receiver_input_channel_4;
  static volatile unsigned long receiver_input_channel_1;
  static volatile unsigned long receiver_input_channel_2;
